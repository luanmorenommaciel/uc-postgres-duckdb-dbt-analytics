# Concept · Transport Stdio Http

> **One-liner:** <TODO: one-line description of transport-stdio-http>
...
- Python SDK (transport wiring, `mcp.run(transport=...)`): <https://github.com/modelcontextprotocol/python-sdk>
