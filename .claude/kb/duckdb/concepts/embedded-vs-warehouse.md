# Concept · Embedded Vs Warehouse

> **One-liner:** <TODO: one-line description of embedded-vs-warehouse>
> **Confidence floor:** 0.95
> **Limit:** ~150 lines. Atomic — one concept per file.

## Source of truth

- Why DuckDB (embedded, in-process design): https://duckdb.org/why_duckdb
- Python API (in-process library, single file): https://duckdb.org/docs/api/python/overview
- Connecting / database files: https://duckdb.org/docs/connect/overview
- MotherDuck (the managed cloud counterpart): https://motherduck.com/docs/
