# Concept · Columnar Vectorized Model

> **One-liner:** <TODO: one-line description of columnar-vectorized-model>
> **Confidence floor:** 0.95
> **Limit:** ~150 lines. Atomic — one concept per file.

## Source of truth

- Why DuckDB (vectorized, columnar execution): https://duckdb.org/why_duckdb
- Performance guide: https://duckdb.org/docs/guides/performance/overview
- EXPLAIN ANALYZE (seeing the vectorized plan): https://duckdb.org/docs/guides/meta/explain_analyze
- See also: `reference/performance-and-explain.md`
