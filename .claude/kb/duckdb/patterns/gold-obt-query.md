# Pattern · Gold Obt Query

> **Solves:** <TODO: problem statement for gold-obt-query>
> **Limit:** ~200 lines. One reusable pattern, production-grade.

## Source of truth

- SQL query syntax (SELECT / JOIN / GROUP BY): https://duckdb.org/docs/sql/query_syntax/select
...
- STRUCT / nested types (for one-big-table shapes): https://duckdb.org/docs/sql/data_types/struct
- See also: `reference/sql-dialect-notes.md`, `reference/performance-and-explain.md`
