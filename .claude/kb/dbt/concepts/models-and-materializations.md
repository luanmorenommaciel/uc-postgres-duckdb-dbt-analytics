# Concept · Models And Materializations

> **One-liner:** <TODO: one-line description of models-and-materializations>
> **Confidence floor:** 0.95
> **Limit:** ~150 lines. Atomic — one concept per file.

## Source of truth

<!-- Cited for a later fill pass. Ground every claim in these. -->

- Materializations: https://docs.getdbt.com/docs/build/materializations
- Models (build): https://docs.getdbt.com/docs/build/models
- `config()` materialized values: https://docs.getdbt.com/reference/dbt-jinja-functions/config
- dbt-duckdb adapter (view/table/external behavior): https://github.com/duckdb/dbt-duckdb
