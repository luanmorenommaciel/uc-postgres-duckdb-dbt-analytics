# Concept · Snapshots Mental Model

> **One-liner:** <TODO: one-line description of snapshots-mental-model>
...
- Snapshots (build): https://docs.getdbt.com/docs/build/snapshots
- Snapshot configs (`strategy`, `unique_key`, `updated_at`, `check_cols`): https://docs.getdbt.com/reference/snapshot-configs
